            ...
            <div class="portlet light ">
              <div class="portlet-title">
                <div class="caption font-dark">
                  ...
                  <span class="caption-subject bold uppercase"> Views</span>
                </div>
              </div>
              ...
              <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                  ...
                  <tbody>
                    ...
                    $msql = "SELECT View_ID, View_Time, View_Platform, View_Browser, View_Device, View_IP, Ads.Ad_Name, AdSpaces.AdSpace_Name FROM Views LEFT JOIN Ads ON Views.View_Ad_ID=Ads.Ad_ID LEFT Join AdSpaces ON Views.View_AdSpace_ID=AdSpaces.AdSpace_Name";
                     ...
                     if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                        echo '<tr class="odd gradeX">
                                <td width="150">'.$row["View_Time"].'</td>
                                <td>'.$row["Ad_Name"].'</td>
                                <td>'.$row["AdSpace_Name"].'</td>
                                <td>'; GetBrowser($row["View_Browser"]);
                                echo '</td>
                                <td>'; GetOS($row["View_Platform"]);
                                echo '</td>
                                <td>';
                                  GetDevice($row["View_Device"]);
                                echo'</td>
                                <td>'.$row["View_IP"].'</td>
                              </tr>';
                      }
